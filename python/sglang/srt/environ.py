...
class Envs:
    ...
    # Deprecated: use --kv-cache-dtype fp4_e2m1 --fp4-kv-cache-recipe mxfp4.
    # Kept as a compatibility alias; see _warn_deprecated_env_to_cli_flag below.
...
_warn_deprecated_env_to_cli_flag(
    "SGLANG_OPT_DSV4_MXFP4_KVCACHE",
    "Please use '--kv-cache-dtype fp4_e2m1 --fp4-kv-cache-recipe mxfp4' instead.",
)
_warn_deprecated_env_to_cli_flag(
